...
from ...functions.derivatives.option import (
    european_call_price as calc_european_call_price, 
    european_put_price as calc_european_put_price, 
    d1 as calc_d1, 
    d2 as calc_d2
)
...
class _Option(Instrument):
    ...
    def __init__(self, premium, strike, style="european", **kwargs):
        """
